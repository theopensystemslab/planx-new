...
export function makeXmlString(passport: Store.passport, sessionId: string) {
  ...
  // format list of file attachments with proposal.xml, application.csv, and user uploads (TODO)
  const fileAttachments = `
    <portaloneapp:FileAttachments>
      <common:FileAttachment>
        <common:Identifier>N10032</common:Identifier>
  ...
  // return a string representing the full proposal.xml schema
  return `
    <?xml version="1.0" encoding="UTF-8"?>
    <root xmlns:portaloneapp="http://www.govtalk.gov.uk/planning/OneAppProposal-2006">
      <portaloneapp:Proposal xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
          xmlns:bs7666="http://www.govtalk.gov.uk/people/bs7666"
          xmlns:org="http://www.govtalk.gov.uk/financial/OrganisationIdentifiers"
          xmlns:pdt="http://www.govtalk.gov.uk/people/PersonDescriptives"
          xmlns:apd="http://www.govtalk.gov.uk/people/AddressAndPersonalDetails"
          xmlns:core="http://www.govtalk.gov.uk/core"
          xmlns:common="http://www.govtalk.gov.uk/planning/OneAppCommon-2006" Version="1.3">
        ...
        <portaloneapp:Applicant>
          ...
          <common:ContactDetails PreferredContactMedium="Email">
