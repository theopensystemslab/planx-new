...
import { makeXmlString2 } from "../xml2";
...
describe("makeXmlString constructor", () => {
  ...
  it("safely escapes special XML characters", () => {
    ...
    const xmlString = makeXmlString2(passport, sessionId, files, hasBoundary);
...
describe("correctly sets planx sessionId as the Uniform reference number", () => {
  ...
  it("sets sessionId", () => {
    const xml = makeXmlString2(passport, sessionId, files, hasBoundary);
...
describe("file handling", () => {
  ...
  it("includes required files", () => {
    ...
    const xmlString = makeXmlString2(
      passport,
      sessionId,
      files,
      hasBoundary,
