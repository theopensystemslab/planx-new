...
describe("Auto-answering blanks", () => {
  ...
  test("Checklists with the same options auto-answer the blank", () => {
    ...
    clickContinue("Path1Checklist1", {
      answers: ["Path1Checklist1Blank"],
      auto: false,
    });
    ...
    expect(autoAnswerableOptions("Path1Checklist2")).toEqual([
  ...
  test("Questions with the same options auto-answer the blank", () => {
    ...
    clickContinue("Path3Question1", {
      answers: ["Path3Question1Blank"],
      auto: false,
    });

    // The second blank is auto-answered because we do not have a passport value but we've seen all options before
    expect(computePassport()?.data).not.toHaveProperty("option");
    expect(autoAnswerableOptions("Path3Question1")).toEqual([
      "Path3Question1Blank",
    ]);
  });
  ...
  test("Checklist then a Question with the same options auto-answer the blank", () => {
    ...
    clickContinue("Path5Checklist", {
      answers: ["Path5ChecklistBlank"],
      auto: false,
    });

    // The second blank is auto-answered because we do not have a passport value but we've seen all options before
    expect(computePassport()?.data).not.toHaveProperty("option");
    expect(autoAnswerableOptions("Path5Question")).toEqual([
      "Path5QuestionBlank",
    ]);
  });
});
...
const flow: Store.Flow = {
  ...
  Path3Question2: {
    ...
    type: 100,
    edges: ["Path3Question2OptionA", "Path3Question2Blank"],
  },
  Path1Checklist1: {
    data: {
      fn: "option",
  ...
  TestPathSelection: {
    ...
    type: 100,
    edges: ["TestPath1", "TestPath2", "TestPath3", "TestPath4", "TestPath5"],
  },
  Path3Question1: {
    data: {
      fn: "option",
    ...
    type: 100,
    edges: ["Path3Question1OptionA", "Path3Question1Blank"],
  },
  Path5Question: {
    data: {
      fn: "option",
  ...
  Path4Question1: {
    ...
    type: 100,
    edges: ["Path4Question1OptionA", "Path4Question1Blank"],
  },
  TestPath2: {
    data: {
      text: "2",
    ...
    type: 200,
    edges: ["Path2Checklist1", "Path2Checklist2"],
  },
  ...
  TestPath5: {
    ...
    type: 200,
    edges: ["Path5Checklist", "Path5Question"],
  },
  ...
  TestPath3: {
    ...
    type: 200,
    edges: ["Path3Question1", "Path3Question2"],
  },
  Path3Question1Blank: {
    data: {
      text: "None",
  ...
  TestPath1: {
    ...
    type: 200,
    edges: ["Path1Checklist1", "Path1Checklist2"],
  },
  TestPath4: {
    data: {
      text: "4",
    ...
    type: 200,
    edges: ["Path4Question1", "Path4Question2", "Path4Question3"],
  },
  Path5ChecklistBlank: {
    data: {
      text: "None",
