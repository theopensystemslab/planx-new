...
describe("Parent-child automations and granularity", () => {
  ...
  test("Selecting `a` and `a.x` only auto-answers `a.x`", () => {
    ...
    clickContinue("Checklist1", { answers: ["Checklist1ParentA", "Checklist1ChildAX"], auto: false });
    ...
    expect(autoAnswerableOptions("Checklist2")).not.toContain("Checklist2ParentA");
    clickContinue("Checklist2", { answers: autoAnswerableOptions("Checklist2"), auto: true });
  ...
  test("Selecting `a` and `b` auto-answers both", () => {
    // Manually answer the first Checklist
    expect(upcomingCardIds()).toEqual(["Checklist1", "Checklist2", "Question"]);
    clickContinue("Checklist1", { answers: ["Checklist1ParentA", "Checklist1ParentB"], auto: false });
    ...
    expect(autoAnswerableOptions("Checklist2")).toEqual(["Checklist2ParentA", "Checklist2ParentB"]);
    clickContinue("Checklist2", { answers: autoAnswerableOptions("Checklist2"), auto: true });
  ...
  test("Selecting `a`, `a.x` and `b` auto-answers `a.x` and `b` if a Checklist and only `a.x` if a Question", () => {
    // Manually answer the first Checklist
    expect(upcomingCardIds()).toEqual(["Checklist1", "Checklist2", "Question"]);
    clickContinue("Checklist1", { answers: ["Checklist1ParentA", "Checklist1ChildAX", "Checklist1ParentB"], auto: false });
    ...
    expect(autoAnswerableOptions("Checklist2")).toEqual(["Checklist2ChildAX", "Checklist2ParentB"]);
    expect(autoAnswerableOptions("Checklist2")).not.toContain("Checklist2ParentA");
    clickContinue("Checklist2", { answers: autoAnswerableOptions("Checklist2"), auto: true });
