...
describe("A filter on the root of the graph", () => {
  ...
  test("Filter options are auto-answered correctly when a higher order flag is collected first", () => {
    expect(upcomingCardIds()).toEqual(["FirstQuestion", "SecondQuestion", "RootFilter", "BranchingQuestion", "EndNotice"]);
    clickContinue("FirstQuestion", { answers: ["FirstQuestionYesAnswer"], auto: false });
  ...
  test("Filter options are auto-answered correctly when a lower order flag is collected first", () => {
    expect(upcomingCardIds()).toEqual(["FirstQuestion", "SecondQuestion", "RootFilter", "BranchingQuestion", "EndNotice"]);
    clickContinue("FirstQuestion", { answers: ["FirstQuestionNoAnswer"], auto: false });
  ...
  test("Filter 'No flag result' option is auto-answered correctly when no flags in this category have been collected", () => {
    expect(upcomingCardIds()).toEqual(["FirstQuestion", "SecondQuestion", "RootFilter", "BranchingQuestion", "EndNotice"]);
    clickContinue("FirstQuestion", { answers: ["FirstQuestionIdkAnswer"], auto: false });
...
describe("A filter on a branch", () => {
  ...
  test("Filter options are auto-answered correctly when a higher order flag is collected first", () => {
    ...
    expect(autoAnswerableOptions("AutoAnswerableChecklist")).toEqual(["ChecklistFacadeAnswer"]);
    clickContinue("AutoAnswerableChecklist", { answers: ["ChecklistFacadeAnswer"], auto: true });
  ...
  test("Filter options are auto-answered correctly when a lower order flag is collected first", () => {
    ...
    expect(upcomingCardIds()?.[0]).toEqual("AutoAnswerableChecklist");
    expect(autoAnswerableOptions("AutoAnswerableChecklist")).toEqual(["ChecklistLandscapingAnswer"]);
    clickContinue("AutoAnswerableChecklist", { answers: ["ChecklistLandscapingAnswer"], auto: true });
  ...
  test("Filter 'No flag result' option is auto-answered correctly when no flags in this category have been collected", () => {
    clickContinue("FirstQuestion", { answers: ["FirstQuestionIdkAnswer"], auto: false });
    clickContinue("SecondQuestion", { answers: ["SecondQuestionIdkAnswer"], auto: false });
    clickContinue("RootFilter", { answers: ["RootFilterNoFlagResult"], auto: true });
    clickContinue("BranchingQuestion", { answers: ["GoToBranchAnswer"], auto: false });
...
describe("Auto-answerable Questions or Checklists on filter paths", () => {
  ...
  test("Are only auto-answered when they are reached and when the path matches the result", () => {
    ...
    expect(upcomingCardIds()?.[0]).toEqual("AutoAnswerableChecklist");
    expect(autoAnswerableOptions("AutoAnswerableChecklist")).toEqual(["ChecklistFacadeAnswer", "ChecklistLandscapingAnswer"]);
  });
