...
11. **PlanX** - Add custom domain to UptimeRobot
    Please clone existing monitor to ensure all integrations are correctly configured, e.g. Slack integrations for SSL reminders.
