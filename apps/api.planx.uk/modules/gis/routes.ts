...
import { findLpaController, getPlanningConstraintsSchemaController } from "./controller.js";
...
router.get("/planning-constraints-schema", validate(getPlanningConstraintsSchemaRequestSchema), getPlanningConstraintsSchemaController);
