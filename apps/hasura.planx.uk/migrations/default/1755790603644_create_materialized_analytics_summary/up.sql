DROP MATERIALIZED VIEW IF EXISTS "public"."analytics_summary_materialized";

CREATE MATERIALIZED VIEW "public"."analytics_summary_materialized" AS 
...
CREATE INDEX idx_analytics_summary_flow_id 
ON "public"."analytics_summary_materialized" (flow_id);

CREATE INDEX idx_analytics_summary_team_service 
ON "public"."analytics_summary_materialized" (team_slug, service_slug);

CREATE INDEX idx_analytics_summary_created_at 
ON "public"."analytics_summary_materialized" (analytics_created_at);

GRANT SELECT ON "public"."analytics_summary_materialized" TO metabase_read_only;