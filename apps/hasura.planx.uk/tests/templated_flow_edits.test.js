...
describe("flow template edits", () => {
  ...
  describe("teamAdmin", () => {
    ...
    test("can create templated_flow_edits", () => {
      expect(i.mutations).not.toContain("insert_templated_flow_edits");
    });

    test("can update templated_flow_edits", () => {
      expect(i.mutations).not.toContain("update_templated_flow_edits");
      expect(i.mutations).not.toContain("update_templated_flow_edits_by_pk");
    });
