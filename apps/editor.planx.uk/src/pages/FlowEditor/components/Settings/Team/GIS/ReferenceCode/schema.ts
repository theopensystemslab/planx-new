      ...
      .test("is-valid-ref-code", "Invalid code format", function (value) {
        ...
        if (value.includes("-")) {
          ...
          return (
            ...
            this.createError({
              message:
                "Invalid format for Local Planning Group reference code. These must match the format ABC-DEF",
            })
          );
        }
        ...
        return (
          ...
          this.createError({
            message:
              "Invalid format for Local Planning Authority reference code. Code must be between 3 and 5 characters long",
          })
        );
      }),
  });
