      ...
      description={
        <>
          <Typography variant="body2">
            Platform admins determine when a team is ready to query planning
            constraints data.
          </Typography>
          <Typography variant="body2">
            Only toggle "on" after manually confirming that council-provided
            datasets have been published to Planning Data so that the risk of
            returning false negatives is low.
          </Typography>
        </>
      }
    >
