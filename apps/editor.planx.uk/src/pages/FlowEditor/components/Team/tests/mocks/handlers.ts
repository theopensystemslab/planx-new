...
import { mockTeamMembersDataWithNoTeamEditors, mockUsersData, newDemoMember, newMember } from "./users";
...
export const getUsersWithNoTeamEditorHandler = () => graphql.query("GetUsersForTeam", () =>
  HttpResponse.json({
    data: { users: mockTeamMembersDataWithNoTeamEditors },
  }),
)

export const createUserHandler = () => graphql.mutation("CreateAndAddUserToTeam", () => {
  server.use(
    graphql.query("GetUsersForTeam", () =>
      HttpResponse.json({
...
export const deleteUserHandler = () => graphql.mutation("SoftDeleteUserById", () =>
  HttpResponse.json({
    data: {
...
export const updateUserHandler = () => graphql.mutation("UpdateUser", () =>
  HttpResponse.json({
    data: {
      update_users: {
        returning: [{
