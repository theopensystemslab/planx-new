...
import { parseResponsiveChecklist, ResponsiveChecklist, type ResponsiveChecklistWithOptions, validationSchema } from "./model";
...
function ResponsiveChecklistComponent(props: Props) {
  ...
  return (
    <BaseChecklistComponent formik={formik} type={type} {...props} />
  )
}
