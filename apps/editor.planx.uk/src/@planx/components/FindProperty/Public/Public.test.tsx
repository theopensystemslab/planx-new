...
const osAddressProps = {
  ...
  "property.address.title": ["103 COBOURG ROAD, LONDON"],
  "property.address.street": ["COBOURG ROAD"],
  "property.address.postcode": ["SE5 0HU"],
  "property.address.postcode.outcode": ["SE5"],
  "property.address.postcode.incode": ["0HU"],
...
const proposedAddressProps = {
  ...
  "property.address.title": ["Land at test and testing"],
  "property.localAuthorityDistrict": ["Southwark"],
  "property.localPlanningAuthority": ["Southwark LPA"],
  "property.region": ["London"],
