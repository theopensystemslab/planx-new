...
const InitialUserInput: React.FC<PublicProps<EnhancedTextInput> & { setUserInput:Dispatch<SetStateAction<string>>}> = (props) => (
  <Formik<{ original: string }>
    initialValues={{ original: "" }}
    onSubmit={({ original }) => props.setUserInput(original)}
