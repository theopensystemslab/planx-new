...
const defaultContent: DrawBoundary = {
  ...
  description:
    "<p>If the map shows a red line select continue if it includes this list below. If the map doesn't show a red line you need to draw the outline to include this list:</p><ul><li><p>the outline of your property boundary</p></li><li><p>any works outside the property boundary</p></li><li><p>areas that will be closed off or you'll need access to during the works</p></li></ul><p>Select <strong>More information</strong> if the red line is incorrect for guidance on how to redraw the outline.</p>",
  howMeasured:
  ...
  descriptionForUploading:
    "<p>Your location plan must:</p><ul><li><p>be based on an accurate, recognisable map</p></li><li><p>be drawn to a scale, labelled, and/or marked with a scale bar</p></li><li><p>show the site outline in red</p></li><li><p>include a north point</p></li></ul><p></p>",
};
