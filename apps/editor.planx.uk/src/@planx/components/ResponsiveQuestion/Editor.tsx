...
import { baseQuestionValidationSchema, buildChildren } from "../shared/BaseQuestion/model";
import { EditorProps } from "../shared/types";
import { parseResponsiveQuestion, ResponsiveQuestion, ResponsiveQuestionWithOptions } from "./model";

export type Props = EditorProps<TYPES.ResponsiveQuestion, ResponsiveQuestion, { options: ConditionalOption[] }>;
...
function ResponsiveQuestionComponent(props: Props) {
  ...
  return (
    <BaseQuestionComponent formik={formik} type={type} {...props} />
  )
}
