ALTER TABLE "public"."lowcal_sessions" ADD COLUMN "allow_list_answers" jsonb null;
COMMENT ON COLUMN "public"."lowcal_sessions"."allow_list_answers" IS E'Non-personal passport values that can be retained for analytics post-sanitation; updated via cron trigger after submission';
