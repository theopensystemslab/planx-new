export const noFiles = {
  ...
  "_address": {
    ...
    "single_line_address": "1, AMERSHAM ROAD, BEACONSFIELD, BUCKINGHAMSHIRE, HP9 2HA"
  },
  "user.role": [
    "applicant"
  ],
  ...
  "application.showTreesConsentResult": [
    "false"
  ],
