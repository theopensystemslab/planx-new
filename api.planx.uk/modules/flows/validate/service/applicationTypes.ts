import { ComponentType, type FlowGraph } from "@opensystemslab/planx-core/types";
...
export const checkStatutoryApplicationTypes = (flattenedFlow:FlowGraph) => {
    ...
    const isStatutoryApplication = applicationTypes.some((value)=> validApplicationTypes?.includes(value))
