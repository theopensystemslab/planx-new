...
const planningConstraints: LocalAuthorityMetadata["planningConstraints"] = {
  article4: {
    ...
    records: {
      ...
      "article4.southwark.hmo": "Change of use from self contained dwelling houses is restricted",
      "article4.southwark.MA": "Change of use from Class E to residential is restricted",
      "article4.southwark.railway": "Demolition on the site restricted",
      "article4.southwark.southernrail": "Conversion of railway arches to residential dwellings is restricted",
    },
  },
};
