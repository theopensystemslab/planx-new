...
export = async () => {
  ...
  // NB. the ssl certs created later for CloudFront are in us-east-1, as required by AWS for CF distributions
  // meanwhile our ALBs require certs in their own region (eu-west-2), which we provision here
